...
$(document).ready(function(){
    ...
    $(".rotater").click(function(){
         ...
         $("fawzy").css({"font-size": "200%" , "  border-radius":"50%" , "background": "rgba(246, 252, 177, 1)"} );
...
$(document).ready(function(){
    $(".rotater").click(function(){
        if (!$('fawzy').hasClass("abc")) {
            ...
            $(".text2").text("Ahmed Raafat");
            $(".text2").wrap('<a href="profiles/raafat.html" />');
            ...
            $(".text2").text("Ahmed Hesham");
             $(".text2").wrap('<a href="profiles/osh.html" />');
            ...
            $(".text2").text("Amal Lasheen");
             $(".text2").wrap('<a href="profiles/amal.html" />');
            ...
            $(".text2").text("Mostafa Gohar");
             $(".text2").wrap('<a href="profiles/gohar.html" />');
            ...
            $(".text2").text("Weam Mahmoud");
             $(".text2").wrap('<a href="profiles/weam.html" />');
            ...
            $(".text2").text("Kareem Saleh");
             $(".text2").wrap('<a href="profiles/kareem.html" />');
            ...
            $(".text2").text("Amr");
             $(".text2").wrap('<a href="profiles/amr.html" />');
            ...
            $(".text2").text("Bassem");
             $(".text2").wrap('<a href="profiles/bassem.html" />');
            ...
            $(".text2").text("Mahmoud");
             $(".text2").wrap('<a href="profiles/mahmoud.html" />');
